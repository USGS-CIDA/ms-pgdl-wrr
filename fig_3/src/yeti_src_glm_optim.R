run_optim_glm <- function(driver_file, nml_file, train_file, test_file, exper_id){
  ...
  optim_multilake_glm(driver_file, nml_file, train_file, test_file, sim_dir) %>%
...
optim_multilake_glm <- function(driver_file, nml_file, train_file, test_file, sim_dir){
  ...
  out = optim(fn = run_cal_simulation, par=initial_params, control=list(parscale=parscale),
              train_filepath = train_filepath, sim_dir = sim_dir, nml_obj = nml_obj, results_log = results_log)
...
run_cal_simulation <- function(par, train_filepath, sim_dir, nml_obj, results_log){
...
run_optim_glm(driver_file, nml_file, train_file, test_file, exper_id)
